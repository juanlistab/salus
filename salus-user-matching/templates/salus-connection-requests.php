            ...
            <div class="salus-connection-request-card">
                <div class="salus-connection-request-card-content">
                    ...
                    <div class="salus-connection-request-card-footer">
                        <button class="salus-connection-request-card-accept" data-requester="<?php echo $requester_id; ?>"><?php _e( 'Accept', 'salus-user-matching' ); ?></button>
                        <button class="salus-connection-request-card-reject" data-requester="<?php echo $requester_id; ?>"><?php _e( 'Reject', 'salus-user-matching' ); ?></button>
                    </div>
                </div>
            </div>
